    ...
    describe("GlobalMock", () => {
        ...
        describe("ctor", () => {
            ...
            it("should create an instance using class as ctor parameter", () => {
                ...
                let mock: TypeMoq.GlobalMock<GlobalBar> = GlobalMock.ofType(GlobalBar, null, container);
            ...
            it("should create an instance using interface as type variable and allow interface cast", () => {
                ...
                let mock: TypeMoq.GlobalMock<IGlobalBar> = GlobalMock.ofType(GlobalBar, null, container);
            ...
            it("should create an instance using interface as type variable and class as ctor parameter", () => {
                ...
                let mock: TypeMoq.GlobalMock<IGlobalBar> = GlobalMock.ofType<IGlobalBar>(GlobalBar, null, container);
            ...
            it("should create an instance using class as ctor parameter and ctor args", () => {
                ...
                let bar = new Bar();
                let foo = new Foo(bar);
                let mock: TypeMoq.GlobalMock<Foo> = GlobalMock.ofInstance(foo, null, container);
            ...
            it("should create an instance using a generic class as ctor parameter and ctor args", () => {
                ...
                let mock: TypeMoq.GlobalMock<GenericFoo<Bar>> = GlobalMock.ofInstance(foo, null, container);
            ...
            it("should create an instance from an existing object", () => {
                ...
                let mock: TypeMoq.GlobalMock<GlobalBar> = GlobalMock.ofInstance(bar, null, container);
            ...
            it("should create an instance from a function object", () => {
                ...
                let mock1: TypeMoq.GlobalMock<() => string> = GlobalMock.ofInstance(someGlobalFunc, null, container);
        ...
        describe("scope.using and .with (auto sandboxing)", () => {
            ...
            it("should check that global no args function is auto sandboxed", () => {
                ...
                let mock = GlobalMock.ofInstance(someGlobalFunc, null, container);
            ...
            it("should check that global function with args is auto sandboxed", () => {
                ...
                let mock = GlobalMock.ofInstance(someGlobalFuncWithArgs, null, container);
            ...
            it("should check that global object is auto sandboxed", () => {
                ...
                let mock = GlobalMock.ofType(GlobalBar, null, container);
            ...
            it("should check that 'XmlHttpRequest' global object is auto sandboxed", () => {
                ...
                let mock = GlobalMock.ofType(XMLHttpRequest, null, container);
