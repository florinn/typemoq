    ...
    describe("GlobalMock", () => {
        ...
        describe("ctor", () => {
            ...
            it("should create an instance using class as ctor parameter and ctor args", () => {
                ...
                let bar = new Bar();
                let foo = new Foo(bar);
                let mock: TypeMoq.GlobalMock<Foo> = GlobalMock.ofInstance(foo, "foo", container);
            ...
            it("should create an instance using a generic class as ctor parameter and ctor args", () => {
                ...
                let mock: TypeMoq.GlobalMock<GenericFoo<Bar>> = GlobalMock.ofInstance(foo, "foo", container);
        ...
        describe("scope.using and .with (auto sandboxing)", () => {
            ...
            it("should check that global function with args is auto sandboxed", () => {
                ...
                mock.verify(x => x(typemoq.It.isAny(), typemoq.It.isAny(), typemoq.It.isAny()), typemoq.Times.never());
                ...
                GlobalScope.using(mock).with(() => {
                    ...
                    mock.verify(x => x(1, 2, 3), typemoq.Times.exactly(2));
            ...
            it("should check that global type is auto sandboxed", () => {
                ...
                mock.verify(x => x.value, typemoq.Times.never());
                ...
                GlobalScope.using(mock).with(() => {
                    ...
                    mock.verify(x => x.value, typemoq.Times.exactly(2));
            ...
            it("should check that 'XmlHttpRequest' global object is auto sandboxed", () => {
                ...
                mock.verify(x => x.send(typemoq.It.isAny()), typemoq.Times.never());
                ...
                GlobalScope.using(mock).with(() => {
                    ...
                    mock.verify(x => x.send(), typemoq.Times.exactly(2));
            ...
            it("should check that 'localStorage' global object is auto sandboxed", () => {
                ...
                GlobalScope.using(mock).with(() => {
                    ...
                    mock.verify(x => x.getItem(typemoq.It.isAnyString()), typemoq.Times.exactly(1));
