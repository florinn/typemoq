namespace TypeMoqIntern {
    ...
    export class GlobalMock<T> implements IGlobalMock<T> {
        ...
        static ofInstance<U>(instance: U, globalName?: string, container: Object = window, behavior = MockBehavior.Loose): GlobalMock<U> {
        ...
        static ofType<U>(ctor: Ctor<U>, globalName?: string, container: Object = window, behavior = MockBehavior.Loose): GlobalMock<U> {
